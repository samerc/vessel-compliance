  ...
  return (
    <div>
      ...
      <fieldset disabled={!canSettings} style={{ border: 'none', padding: 0, margin: 0 }}>
        ...
        {activeTab === 'warClosing' && <RichTextSettingTab settingKey="policy_text_W_closingText" label="War Closing Text" description="The closing section text for War Risk policy documents. Placeholders {tc_text}, {jwla_code}, {jwla_date} are resolved from War Settings — e.g. 'The said Vessel is covered subject to {tc_text} - {jwla_code}'." showSuccess={showSuccess} />}
