...
export interface Api {
  ...
  cargoGetClauseSets: (section?: string) => Promise<CargoClauseSet[]>
  cargoAddClauseSet: (section: string, name: string, clauseIds: string[]) => Promise<CargoClauseSet>
  cargoUpdateClauseSet: (id: string, name: string, clauseIds: string[]) => Promise<void>
  cargoDeleteClauseSet: (id: string) => Promise<void>
