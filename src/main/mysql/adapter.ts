...
export class MySQLAdapter {
    ...
    async initSchema(): Promise<void> {
        ...
        try {
            ...
            // Migration: Create pi_sanctions_versions table
            await this.pool.query(`CREATE TABLE IF NOT EXISTS pi_sanctions_versions (
                id VARCHAR(36) PRIMARY KEY,
            ...
            // Migration: Create pi_warranty_tags table
            await this.pool.query(`CREATE TABLE IF NOT EXISTS pi_warranty_tags (
                id VARCHAR(36) PRIMARY KEY,
                name VARCHAR(100) NOT NULL,
                order_index INT DEFAULT 0,
                created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
            ...
            // Migration: Create pi_warranty_tag_assignments junction table
            await this.pool.query(`CREATE TABLE IF NOT EXISTS pi_warranty_tag_assignments (
            ...
            await this.pool.query(`CREATE TABLE IF NOT EXISTS vessel_insurance_policies (
                id VARCHAR(36) PRIMARY KEY,
                vessel_id VARCHAR(36) NOT NULL,
                policy_category VARCHAR(10) NOT NULL,
                policy_number VARCHAR(100),
                coverage_code VARCHAR(50),
                inception_date VARCHAR(30),
                inception_time VARCHAR(10),
                end_date VARCHAR(30),
                end_time VARCHAR(10),
                currency VARCHAR(10) DEFAULT 'USD',
                hm_value DECIMAL(15,2),
                iv_value DECIMAL(15,2),
                hm_premium DECIMAL(15,2),
                iv_premium DECIMAL(15,2),
                deductible DECIMAL(15,2),
                amd DECIMAL(15,2),
                general_average DECIMAL(15,2),
                limit_of_liability DECIMAL(15,2),
                premium DECIMAL(15,2),
                war_rate VARCHAR(50),
                upcc VARCHAR(50),
                ncb VARCHAR(50),
                our_share VARCHAR(50),
                notes TEXT,
                condition_survey TEXT,
                survey_done VARCHAR(10),
            ...
            await this.pool.query(`CREATE TABLE IF NOT EXISTS classification_societies (
                id VARCHAR(36) PRIMARY KEY,
                name VARCHAR(100) NOT NULL,
            ...
            // Vessel classifications (many-to-many)
            await this.pool.query(`CREATE TABLE IF NOT EXISTS vessel_classifications (
                id VARCHAR(36) PRIMARY KEY,
                vessel_id VARCHAR(36) NOT NULL,
            ...
            // Vessel audit log
            await this.pool.query(`CREATE TABLE IF NOT EXISTS vessel_audit_log (
                id VARCHAR(36) PRIMARY KEY,
                vessel_id VARCHAR(36) NOT NULL,
            ...
            // Dynamic policy characteristics
            await this.pool.query(`CREATE TABLE IF NOT EXISTS policy_type_characteristics (
                id VARCHAR(36) PRIMARY KEY,
                policy_type_id VARCHAR(36) NOT NULL,
                name VARCHAR(100) NOT NULL,
            ...
            await this.pool.query(`CREATE TABLE IF NOT EXISTS policy_type_conditions (
                id VARCHAR(36) PRIMARY KEY,
                policy_type_id VARCHAR(36) NOT NULL,
                name VARCHAR(100) NOT NULL,
                order_index INT DEFAULT 0,
            ...
            await this.pool.query(`CREATE TABLE IF NOT EXISTS vessel_dynamic_policies (
                id VARCHAR(36) PRIMARY KEY,
                vessel_id VARCHAR(36) NOT NULL,
                policy_type_id VARCHAR(36) NOT NULL,
                policy_number VARCHAR(100),
            ...
            // Vessel policy values (EAV)
            await this.pool.query(`CREATE TABLE IF NOT EXISTS vessel_policy_values (
                id VARCHAR(36) PRIMARY KEY,
                ...
                FOREIGN KEY (policy_id) REFERENCES vessel_dynamic_policies(id) ON DELETE CASCADE,
                FOREIGN KEY (characteristic_id) REFERENCES policy_type_characteristics(id) ON DELETE CASCADE
            )`)
